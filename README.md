...
1. support new apps
   - **[Codoon（咕咚）](#codoon 咕咚）** (Couldn't automate for its limitation from the server side)
   - **[Xingzhe（行者）](#xingzhe 行者)**
...
- @[ben-29](https://github.com/ben-29) for awesome [workout page ](https://github.com/ben-29/workouts_page), Great Thanks
