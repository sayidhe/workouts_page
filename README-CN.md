...
1. 支持 APP 数据获取
   ...
   - **[行者](#行者)**
1. 支持 [自驾（Google 路书）](#自驾 google 路书) , 把自驾路线也展示在地图上
...
<details>
<summary>导入谷歌地图的 KML 路书</summary>
...
- @[ben-29](https://github.com/ben-29) 特别棒的功能补充 [workout page ](https://github.com/ben-29/workouts_page), 非常感谢
...
- **[Keep](#keep)**
- **[悦跑圈](#joyrun 悦跑圈)** ：限制单个设备，无法自动化
- **[咕咚](#codoon 咕咚)** ：限制单个设备，无法自动化
- **[郁金香运动](#tulipsport)**
- **[GPX](#gpx)**
- **[TCX](#tcx)**
- **[FIT](#fit)**
