...
const GOOGLE_ANALYTICS_TRACKING_ID = 'G-2Y6E8W3MSB';
...
const CHINESE_LOCATION_INFO_MESSAGE_SECOND = '2024 想去一趟西藏或青海徒步';
...
export const PROVINCE_FILL_COLOR = '#00ed5e'; // green color hex
